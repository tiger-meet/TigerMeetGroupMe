...
from .views import index, about, gmlogin, createchat, joinchat, events, add, details, getgroupname, joinsubchat, destroy
...
urlpatterns = [
    ...
    re_path(r'^edit/(?P<id>[^/]+)/(?P<group_name>\w{0,50})/', edit, name='edit'),    
]
