...
from .views import index, about, gmlogin, createchat, joinchat, events, todo, add, details, getgroupname, joinsubchat, deleteconfirmation, delete
...
urlpatterns = [
    ...
    re_path(r'^delete/(?P<id>[^/]+)/(?P<group_name>\w{0,50})/', delete, name='delete'),
]
